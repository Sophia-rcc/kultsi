<?php
/**
 * Kultsifi functions and definitions
 *
...
if ( ! function_exists( 'kultsifi_setup' ) ) :
	/**
	 ...
	 */
	function kultsifi_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Kultsifi, use a find and replace
		 * to change 'kultsifi' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'kultsifi', get_template_directory() . '/languages' );
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'kultsifi' ),
			)
		);
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'kultsifi_custom_background_args',
				array(
 ...
 */
function kultsifi_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'kultsifi_content_width', 640 );
}
add_action( 'after_setup_theme', 'kultsifi_content_width', 0 );
 ...
 */
function kultsifi_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'kultsifi' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'kultsifi' ),
...
function kultsifi_scripts() {
	...
	wp_enqueue_script('added-features', get_template_directory_uri() . '/js/added-features.js', array('jquery'), _S_VERSION, true);
...
add_action( 'wp_enqueue_scripts', 'kultsifi_scripts' );
